...
# installed.
TCL_PREFIX='F:/Data Science Portfolio/End-to-End/studentPerformanceIndicator/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/Data Science Portfolio/End-to-End/studentPerformanceIndicator/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/Data Science Portfolio/End-to-End/studentPerformanceIndicator/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/Data Science Portfolio/End-to-End/studentPerformanceIndicator/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/Data Science Portfolio/End-to-End/studentPerformanceIndicator/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/Data Science Portfolio/End-to-End/studentPerformanceIndicator/venv\Library\lib\tclstub86.lib'
